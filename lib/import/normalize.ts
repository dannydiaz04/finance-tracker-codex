...
function finalizeNormalizedEvent(
  ...
  return {
    ...
    transactionClass: classifyMovementType(signedAmount, descriptionRaw, {
      accountType: normalizeRawString(canonicalValues.accountType),
      accountSubtype: normalizeRawString(canonicalValues.accountSubtype),
      institutionCategory,
      merchantRaw,
      transactionType: normalizeRawString(canonicalValues.transactionType),
    }),
    rawPayloadJson,
